...
/**
 *Retorna para presenta el valueField del combo en un gridEditor
 */
Ext.ux.comboBoxRenderer = function (combo, value) {
    
    var record = combo.store.find(combo.valueField, value);
    if(record >=0 ) {
        return combo.store.getAt(record).data[combo.displayField];
    }
